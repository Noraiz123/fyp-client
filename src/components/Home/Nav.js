...
const navigation = [
  ...
  { name: 'Repair', href: '#', current: false },
        ...
        <>
          <div className='max-w-7xl mx-auto px-2 sm:px-6 lg:px-8'>
            <div className='relative flex items-center justify-between h-16'>
              ...
              <div className='absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto space-x-2 sm:ml-6 sm:pr-0'>
                ...
                <button className='bg-gray-800 p-1 rounded-full text-gray-400 hover:text-white focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-800'>
                  <span className='sr-only'>View notifications</span>
                  <ShoppingCartIcon className='h-6 w-6 outline-none' aria-hidden='true' />
                </button>
